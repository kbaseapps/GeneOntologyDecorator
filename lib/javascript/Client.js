...
function GeneOntologyDecorator(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.getTermRelationTypes = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "GeneOntologyDecorator.getTermRelationTypes",
            [], 1, _callback, _errorCallback);
    };
 
     this.getTopTermCategories = function (_callback, _errorCallback) {
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        if (_errorCallback && typeof _errorCallback !== 'function')
            throw 'Argument _errorCallback must be a function if defined';
        if (typeof arguments === 'function' && arguments.length > 0+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(0+2)+')';
        return json_call_ajax(_url, "GeneOntologyDecorator.getTopTermCategories",
            [], 1, _callback, _errorCallback);
    };
 
     this.getTermRelations = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "GeneOntologyDecorator.getTermRelations",
            [params], 1, _callback, _errorCallback);
    };
 
     this.listFeatures = function (params, _callback, _errorCallback) {
        if (typeof params === 'function')
            throw 'Argument params can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "GeneOntologyDecorator.listFeatures",
            [params], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "GeneOntologyDecorator.status",
            [], 1, _callback, _errorCallback);
    };
