 ...
 * </pre>
 */
public class KbKeUtilServiceClient {
     ...
     */
    public KbKeUtilServiceClient(URL url) {
     ...
     * validity.
     */
    public KbKeUtilServiceClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public KbKeUtilServiceClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public KbKeUtilServiceClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
     ...
     * validity.
     */
    public KbKeUtilServiceClient(AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public KbKeUtilServiceClient(String user, String password) throws UnauthorizedException, IOException {
